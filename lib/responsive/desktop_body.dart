                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(
                                left: 50.0, right: 0.0, bottom: 8.0, top: 8.0),
                            child: Image.asset(
                      ...
                      FadeInUp(
                        child: Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(
                                left: 0.0, right: 50.0, top: 8.0, bottom: 8.0),
                            child: Image.asset(
                              'assets/website.jpg',
                            ),
                          ),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 13.0, bottom: 13.0, left: 26.0, right: 26.0),
                      child: Text(
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            left: 13.0, right: 26.0, top: 10.0, bottom: 30.0),
                        child: Text(
